...
def detectMask(threshed):
    min_area = cv2.getTrackbarPos('AreaSize', 'Controls')
...
def main():
    ...
    while True:
        ...
        frame_threshed_BLUE = cv2.inRange(roiHSV, (H_min/360*180,S_min/100*255,V_min/100*255), (H_max/360*180,S_max/100*255,V_max/100*255))
        ...
        frame_threshed = cv2.dilate(frame_threshed_BLUE, None, iterations=1)
        ...
        contours = cv2.findContours(frame_threshed_BLUE.copy(), cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[1]
